...
export class schedulesTable1661826458233 implements MigrationInterface {
    name = 'schedulesTable1661826458233'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "schedules" ("id" uuid NOT NULL, "date" character varying NOT NULL, "time" character varying NOT NULL, "propertyId" uuid, "userId" uuid, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
